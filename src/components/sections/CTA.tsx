...
export default function CTA() {
	...
	return (
		...
		>
			{/* Ambient glow */}
			<div className="pointer-events-none absolute left-1/2 top-1/2 h-[800px] w-[800px] -translate-x-1/2 -translate-y-1/2 rounded-full bg-[radial-gradient(ellipse,rgba(37,99,235,0.13)_0%,transparent_70%)]" />
			...
			<div className="relative mx-auto max-w-2xl px-6 text-center">
				...
				{/* Divider */}
				<motion.div
					className="mx-auto mb-5 h-px w-10 bg-white/[0.08]"
					custom={0.15}
					variants={fadeUp}
					initial="hidden"
					animate={inView ? "visible" : "hidden"}
				...
				>
					...
					<a
						href="#services"
						className="inline-flex h-11 items-center justify-center rounded-lg border border-white/[0.1] px-7 text-[13px] font-light tracking-wide text-white/50 transition-all duration-200 hover:-translate-y-px hover:border-white/[0.22] hover:text-white/80 active:translate-y-0"
					>
						View All Services
					</a>
				</motion.div>
				...
				{/* Footer note */}
				<motion.p
					className="border-t border-white/[0.05] pt-6 font-serif text-[13px] italic leading-relaxed text-white/20"
					custom={0.36}
					variants={fadeUp}
					initial="hidden"
					animate={inView ? "visible" : "hidden"}
